...
description = """
fast_api_tmpl API helps you do awesome stuff. 🚀
"""
...
app = FastAPI(
    ...
    terms_of_service="http://fast_api_tmpl.com/terms/",
    contact={
        "name": "sarath-ps",
        "url": "http://fast_api_tmpl.com/contact/",
        "email": "sarath-ps@fast_api_tmpl.com",
    },
    license_info={
        "name": "The Unlicense",
