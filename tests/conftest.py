...
# WARNING: Ensure imports from `fast_api_tmpl` comes after this line
from fast_api_tmpl import app, settings, db  # noqa
from fast_api_tmpl.cli import create_user, cli  # noqa
